 ...
 * @author FPT
 */
@WebServlet(name = "RestoreProductController", urlPatterns = {"/RestoreProductController"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (productID != null && !productID.isEmpty()) {
                ...
                dao.restoreProduct(productID);
            }
        } catch (Exception e) {
            log("Error at RestoreProductController: " + e.toString());
        } finally {
