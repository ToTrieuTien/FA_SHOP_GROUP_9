                ...
                <form action="${pageContext.request.contextPath}/UpdateProductController" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
                    ...
                    <div class="input-group">
                        ...
                        <select name="ddlCategory" style="width: 100%; padding: 10px; margin-top: 5px;">
                            <option value="1" ${PRODUCT_INFO.categoryID == 1 ? 'selected' : ''}>Áo Polo (Nam)</option>
                            <option value="2" ${PRODUCT_INFO.categoryID == 2 ? 'selected' : ''}>Quần Jean</option>
                            <option value="3" ${PRODUCT_INFO.categoryID == 3 ? 'selected' : ''}>Phụ Kiện</option>
                        </select>
                    </div>
